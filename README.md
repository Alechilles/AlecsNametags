...
[![Alec's Nametags! ModStats](https://modstats.io/api/v1/stats/projects/alecs-nametags/embed/card.svg?layout=live&theme=curseforge)](https://modstats.io/stats/alecs-nametags)
...
## Features
- Adds **Nametag**, a craftable naming tool.
- Random name generator with hundreds of international names.
...
1. Craft at a **Farmer's Workbench**
  ...
  - 1x **Gold Bar**
2. Hold **Nametag**.
3. Left click on a valid NPC to name it.
